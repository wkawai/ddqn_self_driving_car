...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        public void RandomInitialize(int startPositionIndex)
        {
            transform.position = startPositions[startPositionIndex].GetComponent<Transform>().position;
            transform.rotation = startPositions[startPositionIndex].GetComponent<Transform>().rotation;
            GetComponent<Rigidbody>().velocity = new Vector3(0, 0, 0);
            GetComponent<Rigidbody>().angularVelocity = new Vector3(0, 0, 0);
            Start();
        }

        public void ManualInitialize(Vector3 position, Quaternion rotation, Vector3 velocity, Vector3 angularVelocity)
        {
